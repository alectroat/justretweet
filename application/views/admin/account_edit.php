...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                       <li><a href="<?=site_url()?>/admin/setting" class="current"><span>Setting</span></a></li>
           </ul>
        </div>
    </div>
<!-- TABS END -->    
...
<!-- CONTENT START -->
    ...
    <div class="portlet">
		...
		<div class="portlet-content nopadding">
         ...
         <form name="frmAddName" method="post" action="<?php echo site_url();?>admin/setting/update/<?=$current_page?>" enctype="multipart/form-data">
		  <?php
		  ...
		  <table border="0" width="100%" align="center">
		   ...
		   <tr>
			...
			<td width="58%"><input type="text" name="account_name" id="account_name" value="<?=$row->account_name?>" width="200" /></td>
		   </tr>
			   
		   <tr>
		    <td>&nbsp;</td>
			<td>
			<input type="hidden" name="package_id" value="<?=$row->pay_acc_id?>" />
