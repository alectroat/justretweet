...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="<?=site_url('admin/setting')?>" class="current"><span>Account Setting</span></a></li>
					  <li><a href="<?=site_url('admin/setting/signupmessage')?>"><span>Sign Up Message</span></a></li>
...
<!-- CONTENT START -->
    ...
    <div class="portlet">
        <div class="portlet-header fixed"> <input type="button" name="back" value="Back" onclick="history.go(-1);" />&nbsp;<font style="padding-left:733px;"><a href="<?=site_url()?>admin/setting/add">Add PayPall Account</a></font></div>
		<div class="portlet-content nopadding">
        <form action="<?php echo site_url();?>admin/package/multidelete/<?= $current_page ?>" method="post" onsubmit="return selectcheckbox();">
		<input type="hidden" name="total" id="total" value="<?=$acount_list->num_rows()?>" />
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
			<?php 
			if($acount_list->num_rows()>0) {
			?>            
			<thead>
              <tr>
                <th width="24" scope="col"><input type="checkbox" name="allbox" id="allbox" value="0" onclick="checkAll(this.value)" /></th>
				<th width="160" scope="col">Account Name</th>
			...
			<?php
			$i = 0;
			foreach($acount_list->result() as $row): 
			?>
              <tr>
                <td width="24"><label>
                ...
                <td width="125" style="text-align:center;">
					<a href="<?php echo site_url();?>admin/setting/edit/<?= $row->pay_acc_id ?>" class="edit_icon" title="Edit This"></a>
					<a href="#" class="delete_icon" onclick="deletePayAcc('<?= $row->pay_acc_id ?>')" title="Delete This"></a>					
				</td>
              </tr>
              <?php
			  $i++;
