...
<!-- CONTENT START -->
    ...
    <div class="portlet">
		...
		<div class="portlet-content nopadding">
         ...
         <form name="frmAddName" method="post" action="<?php echo site_url();?>admin/banner/save" enctype="multipart/form-data">
		  <center><?php if($error){ ?>
		...
		<?php } ?></center>
		  <table border="0" width="100%" align="center">
		   ...
		   <tr>
			...
			<td width="58%"><input type="file" name="banner_img" id="banner_img" value="" />   Note : Image Dimentions only [125 by 125]</td>
		   </tr>
		   ...
		   <tr>
			...
			<td width="58%"><input type="text" style="width:300px" name="banner_url" id="banner_url" value="" /></td>
		   </tr>
