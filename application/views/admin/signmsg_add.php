...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Add Message </h1>
    </div>
    ...
    <div class="portlet">
		...
		<div class="portlet-content nopadding">
         ...
         <form name="frmAddName" method="post" action="<?php echo site_url();?>admin/setting/savemsg" enctype="multipart/form-data">
		...
		<?php } ?></center>
		  <table border="0" width="100%" align="center">
		   ...
		   <tr>
		    <td width="31%" style="padding-left:270px;">Sign Up Message::&nbsp;</td>
			<td width="69%"><input type="text" name="message_name" id="message_name" value=""  size="70"/></td>
		   </tr>
