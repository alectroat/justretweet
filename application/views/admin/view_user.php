...
<link type="text/css" href="<?= base_url()?>asset/css/smoothness/ui.css" rel="stylesheet" />  
	...
	{
		//var username = document.getElementById('username').value;
		window.location = '<?php echo site_url();?>admin/email_list';
	}
...
<!-- CONTENT START -->
    ...
    <div class="portlet">
        <div class="portlet-header fixed" style="height:30px"><div style="float:left"><input type="button" onclick="search_email()" value="Search All Email"/></div><div style="float:right"><input type="button" onclick="search_user();" value="Search"/></div><div style="float:right;margin-left:5px"><input type="text" name="username" id="username" /></div><div style="float:right">Username :  </div></div>
		...
		<input type="hidden" name="total" id="total" value="<?= $user_list->num_rows() ?>" />
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
			...
			<thead>
              <tr>
                <th width="31" scope="col"><input type="checkbox" name="allbox" id="allbox" value="0" onclick="checkAll(this.value)" /></th>
				<th width="177" scope="col">Username</th>
				<th width="190" scope="col">Email</th>
				<th width="84" scope="col">Follower</th>
				<th width="103" scope="col">Following</th>
                <th width="95" scope="col">Credit</th>
				<th width="65" scope="col">Fetr</th>
				<th width="108" scope="col">Status</th>
				<th width="197" scope="col">Join At</th>
                <th width="242" scope="col" style="text-align:center;">Actions</th>
              </tr>
            </thead>
            <tbody>
			<?php
			...
			?>
              <tr>
                ...
                <td width="242" style="text-align:center;">
					...
					<a href="javascript:void(0)" class="delete_icon" onclick="deleteUser('<?= $row->userid ?>','<?= $current_page ?>')" title="Delete This"></a>				</td>
              </tr>
              <?php
			  $i++;
			  endforeach;
