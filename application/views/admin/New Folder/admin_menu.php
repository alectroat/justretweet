<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item last" id="ten"><a href="<?=site_url()?>admin/package" <?php if($menu=='package'){?> class="main current"<?php }else{?>class="main"<?php }?>><span class="outer"><span class="inner settings">Package</span></span></a></li>        
