...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="<?php echo site_url();?>admin/admin/" class="current"><span>Admin Profile</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Admin Profile</h1>
    </div>
    ...
    <div class="portlet">
		...
		<?php
		foreach($admin_info->result() as $row):
		?> 
		  <table border="0" width="100%" align="center">
		   ...
		   <tr>
			...
			<td><?=date("jS M, Y",strtotime($row->create_date))?></td>
		   </tr>
