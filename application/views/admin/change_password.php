    ...
    <div id="tabs">
         <div class="container">
            <ul>
					  ...
					  <li><a href="<?php echo site_url();?>admin/admin/changeUsername" class=""><span>Change Username</span></a></li>
					  <li><a href="<?php echo site_url();?>admin/changepassword/" class="current"><span>Change Password</span></a></li>
           </ul>
        </div>
    </div>
<!-- TABS END -->    
...
<!-- CONTENT START -->
    ...
    <div class="portlet">
		...
		<div class="portlet-content nopadding">
         ...
         <form name="frmAddName" method="post" action="<?php echo site_url();?>admin/changepassword/updatepassword" onsubmit="return check();" enctype="multipart/form-data">
		...
		<?php } ?></center>
		  <table border="0" width="100%" align="center">
		   ...
		   <tr>
		    <td style="padding-left:270px;">Current Password :&nbsp;</td>
			<td width="58%"><input type="password" name="current_password" id="current_password" value="<?php echo isset($current_password)? $current_password : ""; ?>" /></td>
		   </tr>
		   <tr>
		    <td colspan="2">&nbsp;</td>
		   </tr>
		   <tr>
		    <td style="padding-left:270px;">New Password :&nbsp;</td>
			<td width="58%"><input type="password" name="new_password" id="new_password" value="" /></td>
		   </tr>
		    <tr>
		    <td colspan="2">&nbsp;</td>
		   </tr>
		   <tr>
		    <td style="padding-left:270px;">Confirm Password :&nbsp;</td>
			<td width="58%"><input type="password" name="confirm_password" id="confirm_password" value="" /></td>
		   </tr>
		   <tr>
		    <td colspan="2">&nbsp;</td>
		   </tr>
